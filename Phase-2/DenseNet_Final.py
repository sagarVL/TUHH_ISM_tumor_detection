...
test_df_path = 'D:\Education\College\Semester V\ISM\Image_Data\CSV file\label_groundtruth_validation.csv'
...
pre_trained_model = DenseNet201(input_shape=(500, 400, 3), include_top=False, weights="imagenet")
...
model.save("DenseNet_Full_2epoch.h5")
